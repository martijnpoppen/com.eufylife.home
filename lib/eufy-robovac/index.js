...
(function (CleanSpeed) {
    ...
    CleanSpeed["QUIET"] = "Quiet";
    CleanSpeed["TURBO"] = "Turbo";
...
(function (WorkStatus) {
    ...
    // NEW API
    WorkStatus["AUTO"] = "auto";
    WorkStatus["POSITION"] = "position";
    WorkStatus["PAUSE"] = "pause";
    WorkStatus["ROOM"] = "room";
    WorkStatus["ROOM_POSITION"] = "room_position";
    WorkStatus["ROOM_PAUSE"] = "room_pause";
    WorkStatus["SPOT"] = "spot";
    WorkStatus["SPOT_POSITION"] = "spot_position";
    WorkStatus["SPOT_PAUSE"] = "spot_pause";
    WorkStatus["START_MANUAL"] = "start_manual";
    WorkStatus["GOING_TO_CHARGE"] = "going_to_charge";
...
class RoboVac {
    ...
    async getWorkMode(force = false) {
        ...
        const workMode = statuses.dps[this.WORK_MODE];
        if (Object.keys(newAPIStatus).some(key => key === workMode)) {
            return newAPIStatus[this.WORK_MODE];
        }
    ...
    async getWorkStatus(force = false) {
        ...
        const workStatus = statuses.dps[this.WORK_STATUS];
        if (Object.keys(newAPIStatus).some(key => key === workStatus)) {
            return newAPIStatus[this.WORK_STATUS];
        }
